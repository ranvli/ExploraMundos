 ...
 */
public class Juego_Cliente extends javax.swing.JFrame implements Serializable {
    ...
    public Juego_Cliente(serverConns sCon, File mapaCagado) {
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(63, 63, 63))
                    .addComponent(jPanel1, 0, 630, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
...
//        control.leerLista();
    ...
    private void cargaMapa(String name){
        ...
        //carga settings
        int settings[][] = capaDatos.cargaMapa(name.toString(),3);
...
//            mascara = 1;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Error clienteGUI ! " + ex.getMessage());
        }
        ...
        try{
            int[][] mM = (int[][]) ois.readObject();
            int[][] mTops = (int[][]) ois.readObject();
            int[][] settings = (int[][]) ois.readObject();
            
            capaDatos.salvaArchivo("tmp-ExploraMundos-RED", mM, mTops, settings);
            
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Error en salvaArchivo en capadatos : " + e.getMessage());
        }

        cargaMapa("tmp-ExploraMundos-RED");


        //carga avatars !a = crea avatar
        while(true){
            String mensaje;
            try {
                mensaje = (String) ois.readObject();
                if(mensaje.equals("avatarsOK")) break;
                if (mensaje.startsWith("!a")){
                    int paX2 =  ois.readInt();
                    int paY2 =  ois.readInt();
                    iniAvatarSRED(paX2, paY2);
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Error cargando avatars : " + ex.getMessage());
            }
        }
        ...
        JOptionPane.showMessageDialog(rootPane,"Escuchando servidor...");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Juego_Cliente().setVisible(true);
            }
        });
    }
...
//            }
    ...
    public int iniAvatarSRED(int posX, int posY) {
...
//        }
        ...
        posAvatarX[numAvatars] = posX;
        posAvatarY[numAvatars] = posY;
